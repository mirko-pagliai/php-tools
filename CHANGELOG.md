...
* `array_clean()`, `array_has_only_numeric_keys()`, `array_to_string()`, `array_unique_recursive()` and `uncamelcase()`
  global functions are deprecated and will be removed in a future release;
